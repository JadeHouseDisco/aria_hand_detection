...
import socket
import json
from scipy.spatial.transform import Rotation  # Needed for Matrix -> Quat conversion
        ...
        while True:
            ...
            if len(batch_images) > 0:
                ...
                for i in range(len(batch_images)):
                    ...
                    world_rot_mat = R_head @ rot_mat_target
                    ...
                    points_target = (P @ points_cam.T).T
                    
                    # 2. Apply Head Rotation
                    points_world = (R_head @ points_target.T).T
                    ...
                    # 5. SEND DATA
                    if label == "Right":
                        # world_pos is already Head-Compensated and in Forward/Left/Up frame
                        # world_quat is already Head-Compensated and in Forward/Left/Up frame
