...
try:
    # [FIX] Try loading the OFLEX engine first (since that is what we built)
    import selective_scan_cuda_oflex as selective_scan_cuda_core
except ImportError:
    try:
        # Fallback to the original name if OFLEX is missing
        import selective_scan_cuda_core
    except ImportError:
        print("WARNING: can not import selective_scan_cuda_core.")
